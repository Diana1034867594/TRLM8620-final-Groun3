...
let Checkout = {
    ...
    render: async () => {
        ...
        let expMonth = i18n.getString("Checkout", "expMonth");
        let expYear = i18n.getString("Checkout", "expYear");
                            ...
                            <div class="formElement">
                                ...
                                <div id="expDropdown">
                                    <select id="expDate" name="expDate" class="checkoutInput">
                                        <option value="" disabled selected hidden>${expMonth}</option>
                                        `;
        for (let i = 1; i <= 31; i++) {
        ...
        view += `
                                    ...
                                    <select id="expDateYear" name="expDateYear" class="checkoutInput">
                                        <option value="" disabled selected hidden>${expYear}</option>
                                        `;
        for (let i = 1; i <= 12; i++) {
            var formattedNumber = ("0" + i).slice(-2); //$NON-NLS-L$
            view += `<option value="${formattedNumber}">${formattedNumber}</option>`;
